...
@ActiveProfiles( "dev" )
public class LowerNumberOfNoteTest {

    public static final Logger LOGGER = LoggerFactory.getLogger( LowerNumberOfNoteTest.class );
    @Autowired
    ...
    public void testDispense1700() {
        int amount = 1700;
        //1111
        testDispenser( 15, amount,  "0000000103" );
        //1110
    ...
    public void testDispense1000() {
        int amount = 1000;
        //1111
        testDispenser( 15, amount,  "0000000002" );
        //1110
    ...
    public void testDispense5000() {
        int amount = 5000;
        //1111
        testDispenser( 15, amount,  "0000000010" );
        //1110
    ...
    public void testDispense300() {
        int amount = 300;
        //1111
        testDispenser( 15, amount,  "0000010100" );
        //1110
    ...
    public void testDispense8200() {
        int amount = 8200;
        //1111
        testDispenser( 15, amount,  "0000000116" );
        //1110
    ...
    private void testDispenser( int flags, int amount, String expected ){
        try {
            ...
            String buffer = lessNumberOfNotes.dispensed( amount, cassetteUnitHealth );
