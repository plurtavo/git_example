...
@ActiveProfiles( "dev" )
public class LowerNumberOfNoteOneMinorTest {

    public static final Logger LOGGER = LoggerFactory.getLogger( LowerNumberOfNoteOneMinorTest.class );
    @Autowired
    ...
    public void testDispense1300() {
        int amount = 1300;
        //1111
        testDispenser( 15, amount, "0002000102" );
        //1110
        testDispenser( 14, amount, "0002000600" );
        //1101
    ...
    public void testDispense1700() {
        int amount = 1700;
        //1111
        testDispenser( 15, amount, "0002010003" );
        //1110
        testDispenser( 14, amount, "0002000800" );
        //1101
        testDispenser( 13, amount, "0002010003" );
        //1100
        testDispenser( 12, amount, "0002160000" );
        //1011
        testDispenser( 11, amount, "0004000003" );
        //1010
        ...
        //0111
        testDispenser( 7, amount, "0000020003" );
        //0110
    ...
    public void testDispense1000() {
        int amount = 1000;
        //1111
        testDispenser( 15, amount, "0002000201" );
        //1110
    ...
    public void testDispense5000() {
        int amount = 5000;
        //1111
        testDispenser( 15, amount, "0002000209" );
        //1110
    ...
    public void testDispense300() {
        int amount = 300;
        //1111
        testDispenser( 15, amount, "0002000100" );
        //1110
        testDispenser( 14, amount, "0002000100" );
        //1101
    ...
    public void testDispense8200() {
        int amount = 8200;
        //1111
        testDispenser( 15, amount, "0002010016" );
        //1110
        ...
        //1011
        testDispenser( 11, amount, "0004000016" );
        //1010
        ...
        testDispenser( 8, amount, "El numero de notas excede el limite permitido de 50" );
        //0111
        testDispenser( 7, amount, "0000020016" );
        //0110
    ...
    private void testDispenser( int flags, int amount, String expected ) {
        try {
            ...
            String buffer = lessNumberOfNotesOneMinor.dispensed( amount, cassetteUnitHealth );
