...
@ApiModel( description = "Json DTO representación de un ATD (Para realizar transacciones)" )
public class ATDTransactional implements Serializable {
    ...
    public NodeTCP getNode() {
        return node;
    }

    public void setNode( NodeTCP node ) {
        this.node = node;
    }
